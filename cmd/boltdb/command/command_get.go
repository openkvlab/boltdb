...
func newGetCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Short: "get the value of a key from a (sub)bucket in a boltdb database",
...
// getFunc opens the given boltdb db file and retrieves the key value from the bucket path.
