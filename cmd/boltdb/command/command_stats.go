...
func newStatsCommand() *cobra.Command {
	statsCmd := &cobra.Command{
		Use:   "stats <boltdb-file>",
		Short: "print stats of boltdb database",
...
experience corruption, please submit a ticket to the etcd-io/boltdb project page:

  https://github.com/etcd-io/boltdb/issues
`, "\n"),
