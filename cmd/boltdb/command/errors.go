...
var (
	...
	// ErrPathRequired is returned when the path to a boltdb database is not specified.
	ErrPathRequired = errors.New("path required")

	// ErrSurgeryFreelistAlreadyExist is returned when a boltdb database file already has a freelist.
